...
# COPY .evmosd FOLDER to .blackfury FOLDER, EXCLUDE data
cd
rsync -r --verbose --exclude 'data' ./.evmosd/ ./.blackfury/
...
# STARTING blackfury AS A SERVICE
 ...
 wget https://raw.githubusercontent.com/FuryUnderverse/blackfury/noobdate/blackfury.service
...
# blackfury start
ponysay "blackfury node service started, you may try *service blackfury status* command to see it! Welcome to GenesisL1 blockchain!" 
